...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--surface)] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 sm:p-10 bg-[var(--surface-container-lowest)]/80 backdrop-blur-2xl border border-[var(--outline-variant)]/30 rounded-3xl shadow-2xl relative z-10">
        <div className="text-center mb-8">
          <div className="mx-auto w-16 h-16 bg-[var(--surface-container)] rounded-2xl flex items-center justify-center mb-6 shadow-sm border border-[var(--outline-variant)]/20">
            <LogIn className="w-7 h-7 text-[var(--primary)]" />
          </div>
          <h1 className="text-3xl font-display font-extrabold tracking-tight text-[var(--on-surface)]">Welcome back</h1>
          <p className="text-sm font-medium text-[var(--on-surface-variant)] mt-2">Log in to track your subscriptions</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm font-medium text-[var(--on-surface-variant)]">
          ...
          <Link href="/signup" className="text-[var(--primary)] hover:text-[var(--primary-container)] hover:underline font-bold transition-colors">
            Sign up
          </Link>
        </p>
      </div>
